      ...
      <div className="mx-auto w-full max-w-lg">
        ...
        <div className="rounded-3xl border border-[#dac6fb] bg-white p-8 shadow-[0_10px_30px_-20px_rgba(91,33,182,0.55)] sm:p-10">
          ...
          <p className="mt-3 text-[#55337b]">
            Choose a new password for your client portal account. If you did not request this, you
            can close this page.
          </p>
          ...
          {done ? (
            <div className="mt-6 space-y-4">
              ...
              <button
                type="button"
                onClick={() => router.push("/?section=account")}
          ...
          <p className="mt-8 text-center text-sm text-[#6a4a8f]">
            <Link href="/?section=account" className="font-semibold text-[#5b3292] underline">
